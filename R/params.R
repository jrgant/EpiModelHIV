...
param_msm <- function(nwstats,
                      ...
                      max.time.off.tx.full.int = 3640,
                      max.time.on.tx.part.int = 5460,
                      max.time.off.tx.part.int = 3640,
                      vl.acute.rise.int = 42,
                      vl.acute.peak = 6.886,
                      vl.acute.fall.int = 42,
                      vl.set.point = 4.5,
                      vl.aids.onset.int = 3640,
                      vl.aids.int = 728,
                      vl.fatal = 7,
                      vl.full.supp = 1.5,
                      vl.part.supp = 3.5,
                      ...
                      rct.asympt.int = 309.7,
                      uct.asympt.int = 309.7,
                      ct.tx.int = 14,
                      ct.ntx.int = NA,
